...
export default function HeroSection({
  ...
  const renderHeader = (logoSrc: StaticImageData) => (
    <header className="flex gap-[13rem] md:gap-[33rem] lg:gap-[46rem] xl:gap-[88rem] xxl-gap-[90rem] h-[160px] justify-center items-center container mx-auto px-3 p-0 m-0 z-20 mt-3">
      <div>
        <HeroMenu
