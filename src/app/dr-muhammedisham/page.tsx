...
export default function DrMuhammedIsham() {
  return (
    <DoctorPage
      doctorName="Dr. Muhammed Isham"
      ...
      doctorDescription={`Ullamcorper dui varius volutpat primis lacinia elit morbi velit. Lorem ipsum odor amet, consectetuer adipiscing elit.\n
        ...
        Egestas pulvinar mi justo nisl commodo litora litora. Erat scelerisque facilisis ligula augue facilisi class ornare. Consequat sodales porta per aenean platea fusce. Ligula vestibulum curae adipiscing laoreet magnis sodales. Hac rhoncus in non enim suscipit dis.`}
      academicDetails="BSc (Hons), BDS (Lond.), MJDF RCS"
    />
  );
}
