...
export default function Footer() {
  return (
    <div className="mx-auto w-full flex justify-around text-xl px-[150px] my-[40px] ">
      <div className="flex flex-col gap-[60px]">
        ...
        <div className="flex flex-col gap-[15px] ">
          <p className="font-gillSans">hello@aspireclinic.co.uk</p>
          <p className="font-gillSans">27 Mortimer Street, </p>
          <p className="font-gillSans">W1N 7RJ, London, UK</p>
          <p className="font-gillSans">0207 333 333</p>
        </div>
