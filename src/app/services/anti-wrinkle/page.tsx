...
export default function ServiceDetailPage() {
  return (
    <div className="flex flex-col w-full h-full">
      <HeroSection
        title="Anti Wrinkle Injections"
        description="Our Anti-Wrinkle Injections are designed to help you achieve a smoother, more youthful appearance with minimal downtime. Whether you're looking to reduce the appearance of fine lines or prevent deeper wrinkles, our expert team uses the latest techniques to deliver natural-looking results tailored to your needs."
