  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full bg-[#D9D9D9] sm:w-[calc(33.33%-6px)] p-[60px] relative font-opus">
      ...
      <Link className="flex justify-center" href={path}>
        {/* <button className="bg-[#F4F3F0] text-xl px-[100px] py-[30px] rounded-[20px] absolute bottom-24 leading-[22.7px] md:px[20px] md:py-[20px] sm:static">
          Explore
        </button> */}
        <button className="bg-[#F4F3F0] text-xl px-[40px] py-[20px] rounded-[20px] leading-[22.7px] sm:relative sm:bottom-0 sm:px-[100px] md:absolute md:bottom-24">
          Explore
        </button>
      </Link>
    </div>
