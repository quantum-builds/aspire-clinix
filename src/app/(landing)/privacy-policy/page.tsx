  ...
  return (
    <div className="bg-feeGuide min-h-screen">
      ...
      <main className="w-11/12 md:w-4/5 mx-auto py-16 md:py-24 lg:py-36">
        <h1 className="text-4xl font-medium text-trueBlack mt-10 mb-5 font-opus">
          Privacy Policy
        </h1>

        <p className="text-trueBlack font-gillSans mb-6 text-xl">
        ...
        <h2 className="text-3xl font-medium text-trueBlack font-gillSans mt-10 mb-5 ">
          Subheading
        </h2>
        ...
        <h2 className="text-3xl font-medium text-trueBlack font-opus mt-10 mb-5">
          Subheading
        </h2>
        ...
        <ul className="list-disc pl-6 mb-6 text-trueBlack font-gillSans text-xl">
          <li className="mb-2">
