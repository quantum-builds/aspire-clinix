    ...
    <div className="animate-pulse rounded-2xl p-6 space-y-10 bg-dashboardBackground">
      ...
      <div className="flex">
        <div className="flex-1 space-y-3">
          ...
          <div className="h-5 w-28 rounded bg-dashboardTextBlack" />
        </div>
        <div className="flex-1 space-y-3">
          <div className="h-5 w-40 rounded bg-green" />
      ...
      {/* Footer */}
      <div className="flex items-center justify-between">
        <div className="h-6 w-40 rounded bg-dashboardTextBlack" />
        <div className="h-[60px] w-48 rounded-full bg-dashboardBarBackground" />
      </div>
    </div>
  );
}
